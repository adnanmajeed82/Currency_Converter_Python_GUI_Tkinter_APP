...
class CurrencyConverterApp:
    def __init__(self, root):
        ...
        self.currency_list.append("PKR")  # Add PKR to the list
    ...
    def convert(self):
        ...
        try:
            if from_currency == "PKR":
                conversion_rate = 1 / self.currency_rates.get_rate(to_currency, "USD")
            elif to_currency == "PKR":
                conversion_rate = self.currency_rates.get_rate(from_currency, "USD")
            else:
